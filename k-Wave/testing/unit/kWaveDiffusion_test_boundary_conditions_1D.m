function test_pass = kWaveDiffusion_test_boundary_conditions_1D(plot_comparisons, plot_simulations) 
% DESCRIPTION:
...
offset = 10*dx;
width = dx*6;
source.T0 = exp(-((kgrid.x - offset)/width).^2);

% define homogeneous temperature distribution
source_homog.T0 = ones(Nx, 1);
