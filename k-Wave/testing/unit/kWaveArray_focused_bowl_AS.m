function test_pass = kWaveArray_focused_bowl_AS(plot_simulations, plot_comparisons)
%KWAVEARRAY_FOCUSED_BOWL_AS Compare with analytical solution for a focused bowl.
%
% DESCRIPTION:
