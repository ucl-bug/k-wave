function test_pass = kspaceFirstOrder3D_check_source_scaling_uy(plot_comparisons, plot_simulations)
% DESCRIPTION:
...
u_mask(1 + pml_size:Nx - pml_size, 1 + pml_size, 1 + pml_size:Nz - pml_size) = 1;
...
sensor.mask(Nx/2, Ny - pml_size, Nz/2) = 1;
