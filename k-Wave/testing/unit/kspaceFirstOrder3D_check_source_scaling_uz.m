function test_pass = kspaceFirstOrder3D_check_source_scaling_uz(plot_comparisons, plot_simulations)
% DESCRIPTION:
...
u_mask(1 + pml_size:Nx - pml_size, 1 + pml_size:Ny - pml_size, 1 + pml_size) = 1;
...
% recreate the source
source_no_correction.uz = createCWSignals(kgrid.t_array, freq, 1, 0) / (medium.sound_speed * medium.density);
