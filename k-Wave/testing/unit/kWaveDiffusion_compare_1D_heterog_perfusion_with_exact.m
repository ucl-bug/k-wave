function test_pass = kWaveDiffusion_compare_1D_heterog_perfusion_with_exact(plot_comparisons, plot_simulations) 
% DESCRIPTION:
...
blood_perfusion_rate_1 = 0.01;  % [1/s]
blood_perfusion_rate_2 = 0.05;  % [1/s]

% calculate perfusion coefficient
