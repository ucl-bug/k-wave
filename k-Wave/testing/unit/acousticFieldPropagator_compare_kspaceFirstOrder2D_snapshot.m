function test_pass = acousticFieldPropagator_compare_kspaceFirstOrder2D_snapshot(plot_comparisons, plot_simulations)
% DESCRIPTION:
...
aperture(Nx/2 - aperture_width + 1: Nx/2 + aperture_width, Ny/2) = 1;
