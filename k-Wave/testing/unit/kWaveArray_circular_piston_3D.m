function test_pass = kWaveArray_circular_piston_3D(plot_simulations, plot_comparisons)
%KWAVEARRAY_CIRCULAR_PISTON_3D Compare with analytical solution for circular piston.
%
% DESCRIPTION:
...
karray = kWaveArray('BLITolerance', 0.03, 'UpsamplingRate', 16);
