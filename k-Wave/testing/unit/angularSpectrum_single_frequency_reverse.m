function test_pass = angularSpectrum_single_frequency_reverse(plot_comparisons, plot_simulations)
% DESCRIPTION:
...
%     angularSpectrumCW. In this examples, the optional input 'Reverse' is
%     set to true.
%
% ABOUT:
...
% run simulation
[~, output_data_tv] = angularSpectrum(source_plane_time, dx, dt, (Nz - 1)*dx, c0, ...
...
output_data_cw = angularSpectrumCW(disc, dx, (Nz - 1) * dx, f0, c0, 'Reverse', true);
