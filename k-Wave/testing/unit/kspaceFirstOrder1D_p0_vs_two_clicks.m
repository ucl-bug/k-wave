function test_pass = kspaceFirstOrder1D_p0_vs_two_clicks(plot_comparisons, plot_simulations)
% DESCRIPTION:
...
% run the simulation
sensor_data2 = kspaceFirstOrder1D(kgrid, medium, source, sensor, ...
    'PMLAlpha', 0, ...
    'PlotSim', plot_simulations);
...
if plot_comparisons
    ...
    subplot(3, 1, 3);
    plot(abs(sensor_data.' - sensor_data2.'));
    title('difference');
