function test_pass = kspaceFirstOrder3D_compare_labelled_and_binary_source_mask(plot_comparisons, plot_simulations)
% DESCRIPTION:
...
sensor_data_labelled = kspaceFirstOrder3D(kgrid, medium, source, sensor, input_args{:});
...
sensor_data_binary = kspaceFirstOrder3D(kgrid, medium, source, sensor, input_args{:});
