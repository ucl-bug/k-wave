function test_pass = kspaceFirstOrderAS_compare_binary_and_cuboid_sensor_mask(plot_comparisons, plot_simulations)
% DESCRIPTION:
...
% run the simulation
sensor_data_cuboids = kspaceFirstOrderAS(kgrid, medium, source, sensor, input_args{:});
...
% run the simulation
sensor_data_comp1 = kspaceFirstOrderAS(kgrid, medium, source, sensor, input_args{:});
...
% run the simulation
sensor_data_comp2 = kspaceFirstOrderAS(kgrid, medium, source, sensor, input_args{:});
