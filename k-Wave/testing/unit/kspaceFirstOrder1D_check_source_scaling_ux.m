function test_pass = kspaceFirstOrder1D_check_source_scaling_ux(plot_comparisons, plot_simulations)
% DESCRIPTION:
%     Unit test to check the k-space source correction in
%     kspaceFirstOrder1D for a velocity source.
%
% ABOUT:
