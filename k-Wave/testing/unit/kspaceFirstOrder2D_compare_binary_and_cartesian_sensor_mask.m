function test_pass = kspaceFirstOrder2D_compare_binary_and_cartesian_sensor_mask(plot_comparisons, plot_simulations)
% DESCRIPTION:
...
sensor_data_c_ln = kspaceFirstOrder2D(kgrid, medium, source, sensor, ...
    'PlotSim', plot_simulations);

% run the simulation using nearest-neighbour interpolation
sensor_data_c_nn = kspaceFirstOrder2D(kgrid, medium, source, sensor, ...
    'CartInterp', 'nearest', ...
    'PlotSim', plot_simulations);
...
sensor_data_b = kspaceFirstOrder2D(kgrid, medium, source, sensor, ...
    'PlotSim', plot_simulations);
