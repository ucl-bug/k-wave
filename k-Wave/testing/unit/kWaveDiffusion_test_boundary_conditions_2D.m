function test_pass = kWaveDiffusion_test_boundary_conditions_2D(plot_comparisons, plot_simulations) 
% DESCRIPTION:
...
if plot_comparisons
    ...
    axis image;
    subplot(2, 1, 2);
    plot(squeeze(kdiff.T(:, round(Ny/2))));
end
