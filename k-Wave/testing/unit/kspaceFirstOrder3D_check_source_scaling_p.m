function test_pass = kspaceFirstOrder3D_check_source_scaling_p(plot_comparisons, plot_simulations)
% DESCRIPTION:
%     Unit test to check the k-space source correction in
%     kspaceFirstOrder3D for a pressure source.
%
% ABOUT:
...
p_mask = zeros(Nx, Ny, Nz);
p_mask(1 + pml_size, 1 + pml_size:Ny - pml_size, 1 + pml_size:Nz - pml_size) = 1;
